...
<div class="container"  onload="cuestionario();">
<script src="{{ asset('js/preguntas.js') }}"></script>
  <div class="row justify-content-md-center">
    <div class="col-md-12">

        <div class="card-body">
            <form method="post" action="{{ route('alumno.storeEvaluacion') }}" >
                {{ csrf_field() }}
                ...
                <div id="div_registro" class="form-group row" hidden>
                    <div class="col-sm-8">
                        ...
                        @endif 
                        @if(!empty($resultado))  
                        <input id="registro-input" class="form-control" type="text" name="resultadoAnterior" value='{{ $resultado->resultado }}' >
                        @endif
                ...
                @foreach($docente as $docente)              
                    <div id="div_registro" class="form-group row" >
                        <div class="col-sm-8" hidden>
                            <input id="registro-input" class="form-control"  role="select" type="text" name="docente_id" value='{{ $docente->id}}' >
                        </div>
