...
<div class="container" id="container-evaluación">
  <div class="row justify-content-md-center col-12">
    ...
    <div class="card-body col-md-12">
      <form method="post" action="/admin/evaluacion/{{$categoria->id}}/editCategorias" class="form-inline">
        @method('put')
        {{ csrf_field() }}   
        <label id="div_registro" for="categoria" class="col-form-label col-md-12">CATEGORÍA :</label>
        <input id="registro-input" class="form-control col-md-12" type="text" name="categoria" value="{{ $categoria->categoria }}">
