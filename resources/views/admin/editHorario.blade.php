        ...
        @endif
                  ...
                  <div id="div_registro" class="form-group row">
                    ...
                    <div id="div_registro" class="form-group row">
                        ...
                        <select style="width:280px" class="select-css" id="semestre" >
                            <option selected="true" disabled="disabled" >{{ $horarioMateria->semestre }}</option>
            ...
            <form method="post" action="/admin/{{$horario->id}}/editHorario">
                ...
                <div id="div_registro" class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input  id="materias"  class="form-control" type="text"  placeholder="{{ $horarioDocente->apellido1 }}"
                                style="background-color:transparent" readonly>
