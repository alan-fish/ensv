...
<div class="container" id="container-evaluación">
  <div class="row justify-content-md-center col-12">
    ...
    <div class="card-body col-md-12">
      <form method="post" action="{{ route('admin.storePregunta') }}" class="form-inline">   
        {{ csrf_field() }}
        <div id="div_registro" class="form-group row">
            <label for="categoria" class="col-form-label col-sm-2">CATEGORÍA:</label>         
            <div class="col-sm-8">
                <select style="width:280px" class="custom-select" id="categoria" name="categoria_id">
        ...
        <input id="registro-input" class="form-control col-md-12" type="text" name="pregunta">
