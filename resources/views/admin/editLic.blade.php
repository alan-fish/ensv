...
<div class="container" id="container-resgistroalumno">
    <div class="row justify-content-md-center">
        ...
        <h3 style="font-weight: bold">EDITAR LICENCIATURA</h3>
        </div>
         
         <div class="card-body">

         <form id="agregarLicenciatura" method="post"  action="/admin/{{$licenciatura->id}}/editLic" class="form-inline">   
            @method('put')
            {{ csrf_field() }}
                <label id="div_registro" for="licenciatura" class="col-form-label col-sm-2">LICENCIATURA:</label>
                <input id="registro-input" class="form-control col-sm-6" type="text" name="carrera"  value="{{ $licenciatura->carrera }}">
