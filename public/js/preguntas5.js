$(document).ready(function(){
    function cuestionario5(){
        $.get('/alumno/preguntas5', function(preguntas5){  
            var respuetas_seletc = ''; 
            var pregunta_label ='';
            var j = 1;
            for (var i=0; i<preguntas5.length; i++) {
                pregunta_label+='<label for="preguntas" class="form-group col-sm-10"  >'+preguntas5[i].pregunta+'</label>';
